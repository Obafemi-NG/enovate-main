    ...
    <>
      ...
      <div onClick={closeDropDown} className={styles["page-container"]}>
        <div className={styles.top}>
          ...
          <ul className={styles["about-details"]}>
            ...
            <li className={styles["about-list"]}>
              ...
              growing your company, no job&rsquo;s too small for us, nor is any
              challenge too big for us to handle.
            </li>
            <li className={styles["about-list"]}>
              We are remote and have great team of creative techies spread
              across continents. We&rsquo;re extremely passionate about what we
              do, and we&rsquo;re amazing at it.
            </li>
          </ul>
        </div>
        <h3 className={styles.bandwagon}>We are builders & innovators</h3>
